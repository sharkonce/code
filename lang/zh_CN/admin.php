...
return [
    'tgbot'=>[
        ...
        'lose_rate'=>'中雷赔付倍数',
        'valid_time'=>'红包过期时间(秒)',
        'default_balance'=>'注册赠送金额',
        'platform_commission'=>'【包主】平台抽成比例5%',
        'platform_get_commission'=>'【抢方】平台抽成比例5%',
        'welcome'=>'欢迎语',
        'help'=>'帮助信息',
        'thunder_chance'=>'中雷概率(%)【30%表示10包有3包有雷】',
        'share_rate'=>'推广抽成(%)【下级发包盈利抽成】',
        'invite_usdt'=>'邀请奖励(U)【邀请成员进群账户自动返现】',
        'leopard_reward'=>'3连豹子奖励(U)【自动发送奖励以及通知】',
        'straight_reward'=>'3连顺子奖励(U)【自动发送奖励以及通知】',
        'self_lucky'=>'是否可抢自己红包:1为可抢，0为不可抢',
        'min_amount'=>'红包最低金额',
        'max_amount'=>'红包最高金额',
        'auto_get_sec'=>'假人自动抢包介入时间(秒)',
        'straight_reward_4'=>'4连顺子奖励(U)【自动发送奖励以及通知】',
        'straight_reward_5'=>'5连顺子奖励(U)【自动发送奖励以及通知】',
        'leopard_reward_4'=>'4连豹子奖励(U)【自动发送奖励以及通知】',
        'leopard_reward_5'=>'5连豹子奖励(U)【自动发送奖励以及通知】',
        'straight_rate'=>'顺子概率(%)',
        'leopard_rate'=>'豹子概率(%)',
        'finance'=>'财务ID（上下分使用），多个财务以逗号隔开',
    ],
    'scaffold' => [
        'header'            => '代码生成器',
        'choose'            => '选择已有数据表',
