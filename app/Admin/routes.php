...
Route::group([
    ...
    $router->get('tgusers/report', 'TgUserController@report');
    ...
    $router->resource('inviterecord', 'InviteRecordController');
    $router->resource('rewardrecord', 'RewardRecordController');
    $router->resource('sharerecord', 'ShareRecordController');
    $router->resource('rechargerecord', 'RechargeRecordController');
    $router->resource('commissionrecord', 'CommissionRecordController');
    $router->resource('withdrawrecord', 'WithdrawRecordController');
    $router->resource('moneylog', 'MoneyLogController');
